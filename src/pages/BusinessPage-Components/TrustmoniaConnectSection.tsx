...
export default function TrustmoniaConnectSection() {
  return (
    <div className='bg-blue  text-center landscape:h-[70vw] portrait:h-[455vw] portrait:pt-[10%]   portrait:sm:h-[360vw] w-[100vw]  text-darkgreen flex justify-center items-center '>
  ...
  <span>SCHOOL SUPPORT MARKET PLACE CONNECT</span>
</div>

<div className="header mb-[5%] w-full flex justify-center items-center   text-[2.3vw]  portrait:text-[6vw]  portrait:sm:text-[4vw]">
  <span>Bring your business to life with SCHOOL SUPPORT MARKET PLACE CONNECT</span>
</div>
...
<div className="summary w-full  flex justify-center items-center  text-[2vw]  portrait:text-[6vw]  portrait:sm:text-[3vw]">
  ...
  <span className='w-[70%]  portrait:w-full   portrait:sm:w-full  text-center flex-col'>
    ...
    SCHOOL SUPPORT MARKET PLACE CONNECT lets you post regular updates so you can help potential customers learn more about your business.
    </div>
...
<div className="heading">3-Your Posts will be Promoted every Week by Our Market Place </div>
