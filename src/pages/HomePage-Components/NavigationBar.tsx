...
export default function NavigationBar() {
  ...
  return (
    <div ref={nav}  className=' relative h-[5vw] portrait:h-[15vw]  portrait:sm:h-[10vw] bg-darkgreen text-light flex items-center justify-center portrait:flex-col'>
